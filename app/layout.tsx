...
import "./globals.css";
import { fraunces, inter, cormorant, manrope } from "./fonts";
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className={`${fraunces.variable} ${inter.variable} ${cormorant.variable} ${manrope.variable} bg-paper text-graphite font-body`}>
        <Preloader />
